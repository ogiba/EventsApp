...
namespace EventsApp
{
    ...
    /// </summary>
    public sealed partial class GetNewPasswordPage : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();
        private MessageDialog mg;

        public GetNewPasswordPage()
        {
        ...
        private void resetBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            RequestConnector connector= new RequestConnector("/auth/passwdreset",mg);
        ...
        {
            mg = new MessageDialog("", "");
            switch (e.Message.StatusCode)
            {
                case System.Net.HttpStatusCode.OK:
                    mg.Title="Done";
                    mg.Content="Password has been change";
                    await mg.ShowAsync();
                    Frame.Navigate(typeof(MainPage));
                    break;
                case System.Net.HttpStatusCode.NotFound:
                    mg.Title = "Error";
                    mg.Content = "Email was not found";
                    await mg.ShowAsync();
                    break;
                case System.Net.HttpStatusCode.BadRequest:
                    mg.Title = "Warrning";
                    mg.Content = "Not specifed mail address";
                    await mg.ShowAsync();
                    break;
            }
        }
